...
class BeerControllerTest {
    ...
    void testPatchBeers() throws Exception{
        ...
        beerMap.put("beerName", "New Name");
         ...
         mockMvc.perform(patch(BeerController.BEER_PATH_ID, beer.getId())
                 .contentType(MediaType.APPLICATION_JSON)
                         .with(jwtRequestPostProcessor)// will not work only works for get operations without configuring
                 .accept(MediaType.APPLICATION_JSON)
    ...
    void testUpdateBeer() throws Exception {
        ...
        verify(beerService).updateBeerById(any(UUID.class),any(BeerDTO.class));//.updateBeerByID(any(UUID.class), any(Beer.class));
